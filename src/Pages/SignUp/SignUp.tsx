...
import { Loader2, ShieldCheck, MapPin, Briefcase } from "lucide-react";
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <Input
                  id="password"
                  type="password"
                  className={`rounded-xl h-11 ${errors.password ? "border-red-500" : ""}`}
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                />
              </div>
              <div className="space-y-1">
                <Label htmlFor="confirm">Sahkan</Label>
                <Input
                  id="confirm"
                  type="password"
